...
## Create Layer 3 & 5
import csv
file_path = 'D:/Master_NSYSU/CodeRepository_ThisPeriod/zhar_antenna_design/py_helper/2026_1_11_metasurfaceBuilder/antenna_design_18x18_merged.csv'
...
for i, row in enumerate(csv_data):
	create_cap2(
		...
		oEditor=oEditor,
		oDesign=oDesign,
		name_cap="layer3cap"+str(layer3_cap_index),
	...
	create_cap3(
		...
		oEditor=oEditor,
		oDesign=oDesign,
		name_cap="layer5cap"+str(layer5_cap3_index),
		position_grid_x=row['x'],
		position_grid_y=row['y'],
